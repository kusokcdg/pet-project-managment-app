export default function SideBar() {
    return (
        <aside className="fixed top-16 h-screen w-64 rounded-tr-[20px] bg-stone-900">
            ...
            <button className="relative text-zinc-500 bg-neutral-700 top-16 left-8  rounded-md py-2 px-4 hover:bg-neutral-600">+ Add Project </button>
            <ul className="flex flex-col break-words  relative top-16 p-8 space-y-4  text-zinc-500 ">
                {/* grid justify-start */}
                <li>
                    <button className="text-left w-full pl-2 py-1 rounded-sm hover:bg-neutral-600 hover:text-stone-300">ASDtitle1</button>
                </li>
                <li>
